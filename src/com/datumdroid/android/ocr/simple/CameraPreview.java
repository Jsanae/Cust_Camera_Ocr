...
// versus https://github.com/asauron/ZombeeWatch/blob/master/src/apc/examples/CameraView.java
...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
	...
	int width;
	int height;
	ZoomControls _zoomControls = new ZoomControls(getContext());
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		// draw.
	// 	mCamera = Camera.open();	//nok done dans CameraActivity
		...
		if (this.getResources().getConfiguration().orientation != Configuration.ORIENTATION_LANDSCAPE) {
			params.set("orientation", "landscape"); // "landscape"
